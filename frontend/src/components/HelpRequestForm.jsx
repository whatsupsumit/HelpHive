            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-2xl font-bold text-transparent bg-gradient-to-r from-yellow-600 via-amber-600 to-orange-600 bg-clip-text">
                  Request <span className="text-transparent bg-gradient-to-r from-orange-500 via-yellow-500 to-amber-500 bg-clip-text">Help</span>
                </h2>
              </div>
              <button
                onClick={onClose}
          ...
          <div className="relative flex-1 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-track-amber-100/50 scrollbar-thumb-gradient-to-r scrollbar-thumb-from-yellow-400/70 scrollbar-thumb-to-orange-400/70 hover:scrollbar-thumb-from-yellow-500/80 hover:scrollbar-thumb-to-orange-500/80 scrollbar-corner-transparent"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 bg-gradient-to-r from-white/90 via-yellow-50/80 to-amber-50/80 border border-yellow-300/60 rounded-xl text-gray-800 focus:border-orange-500 focus:ring-2 focus:ring-yellow-400/30 focus:outline-none transition-all duration-300 shadow-lg backdrop-blur-sm"
                  required
                />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea
                ...
                value={formData.thankingMessage}
                onChange={handleInputChange}
                placeholder="A message to thank helpers who respond to your request..."
                rows="3"
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-6 pb-2">
              ...
              <button
                type="submit"
                className="flex-1 px-6 py-3 bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 hover:from-yellow-500 hover:via-orange-600 hover:to-yellow-700 text-white font-bold rounded-xl transition-all duration-300 shadow-xl border border-orange-300/60 backdrop-blur-sm hover:scale-[1.02] hover:shadow-orange-400/40"
              >
