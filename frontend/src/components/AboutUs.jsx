      ...
      <div className="relative">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 drop-shadow-2xl">
                Our <span className="text-transparent bg-gradient-to-r from-yellow-700 via-orange-700 to-red-700 bg-clip-text">Foundation</span>
              </h2>
              ...
              <div className="group relative bg-gradient-to-br from-black/20 via-gray-700/40 to-black/20 backdrop-blur-xl border border-yellow-400/30 rounded-3xl p-10 md:p-12 hover:border-yellow-400/60 transition-all duration-500 shadow-2xl hover:shadow-yellow-400/20">
                ...
                <div className="relative">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold text-gray-900 drop-shadow-lg">Our Mission</h3>
                  </div>
              ...
              <div className="group relative bg-gradient-to-br from-black/20 via-gray-700/40 to-black/20 backdrop-blur-xl border border-orange-400/30 rounded-3xl p-10 md:p-12 hover:border-orange-400/60 transition-all duration-500 shadow-2xl hover:shadow-orange-400/20">
                ...
                <div className="relative">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold text-gray-900 drop-shadow-lg">Our Vision</h3>
                  </div>
                  <p className="text-base md:text-lg text-gray-900 leading-relaxed font-light">
        ...
        <section className="relative py-24 px-6 sm:px-8 lg:px-12 overflow-hidden">
          <div className="relative z-10 max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 drop-shadow-2xl">
                What We <span className="text-transparent bg-gradient-to-r from-yellow-700 via-orange-700 to-red-700 bg-clip-text">Do</span>
              </h2>
              <p className="text-lg md:text-xl text-gray-900 max-w-3xl mx-auto leading-relaxed font-light">
              ...
              {[
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 drop-shadow-lg">{feature.title}</h3>
                    <p className="text-gray-900 leading-relaxed font-light text-sm">{feature.description}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="relative bg-black/15 backdrop-blur-xl border border-yellow-400/30 rounded-3xl p-12 md:p-16 shadow-2xl">
              ...
              <div className="relative max-w-4xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 drop-shadow-2xl">
                  Rooted in <span className="text-transparent bg-gradient-to-r from-yellow-700 via-orange-700 to-red-700 bg-clip-text">Indian Values</span>
                </h2>
                <p className="text-base md:text-lg text-gray-900 leading-relaxed font-light">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-8 drop-shadow-2xl">
                  Our <span className="text-transparent bg-gradient-to-r from-yellow-700 via-orange-700 to-red-700 bg-clip-text">Story</span>
                </h2>
              ...
              <div className="relative bg-black/20 backdrop-blur-xl border border-purple-400/30 rounded-3xl p-8 md:p-10 shadow-2xl">
                ...
                <div className="relative text-center">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 drop-shadow-lg">
                    Innovation Meets <span className="text-transparent bg-gradient-to-r from-yellow-700 to-orange-700 bg-clip-text">Compassion</span>
                  </h3>
        ...
        <section className="relative py-24 px-6 sm:px-8 lg:px-12 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            <div className="text-center relative bg-black/15 backdrop-blur-2xl border border-yellow-400/30 rounded-3xl p-12 md:p-16 shadow-2xl">
              ...
              <div className="relative">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 drop-shadow-2xl">
                  Join Our <span className="text-transparent bg-gradient-to-r from-yellow-700 via-orange-700 to-red-700 bg-clip-text">Community</span>
                </h2>
